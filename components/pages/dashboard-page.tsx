...
export default function DashboardPage() {
  return (
    <div className="space-y-6">
      ...
      {/* Hero Section */}
      <Card className="bg-gradient-to-r from-slate-800 to-slate-900 text-white overflow-hidden border-0">
        <CardContent className="p-8">
          <div className="flex items-center justify-between">
            <div className="space-y-4">
              <div className="space-y-2">
                <h1 className="text-4xl font-bold text-balance">هوشکال</h1>
                <p className="text-xl opacity-90 text-balance">همراه هوشمند شما در هر تماس</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold persian-numbers">۵۵.۳ ثانیه</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
              ...
              <Badge variant="default" className="bg-green-500 persian-numbers">
                ۱۲۳
              </Badge>
            </div>
            <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
              <span className="text-sm font-medium">به پایان رسیده</span>
              <Badge variant="default" className="bg-blue-500 persian-numbers">
                ۲۲۲
              </Badge>
            </div>
            <div className="flex justify-between items-center p-3 bg-orange-50 rounded-lg">
              <span className="text-sm font-medium">در انتظار</span>
              <Badge variant="default" className="bg-orange-500 persian-numbers">
                ۴۵
              </Badge>
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            <div className="flex justify-between items-center p-3 bg-muted/50 rounded-lg">
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-muted-foreground persian-numbers">%۴۷</div>
              </div>
            </div>
            <div className="flex justify-between items-center p-3 bg-muted/50 rounded-lg">
